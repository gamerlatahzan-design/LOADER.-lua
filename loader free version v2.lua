...
-- [[ BASE GITHUB URL ]]
local BASE_URL = "https://raw.githubusercontent.com/gamerlatahzan-design/SSLH-SourceCode-/main/"
        ...
        Options = {
            {
                ...
                ScriptURL = "SourceCodeTBDFreeMaxVersion.lua"
            },
            {
                Name = "Timebomb Duels Lite",
                ScriptURL = "SourceCodeTBDFreeLiteVersion.lua"
            }
        }
    },
    [98752102030179] = {
