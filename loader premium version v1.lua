...
-- [[ BASE GITHUB URL ]]
local BASE_URL = "https://raw.githubusercontent.com/gamerlatahzan-design/SSLH-SourceCode-/refs/heads/main/"
        ...
        Options = {
            {
                ...
                ScriptURL = "SourceCodeTBDVIPMaxVersion.lua"
            },
            {
                Name = "Timebomb Duels Lite",
                ScriptURL = "SourceCodeTBDVIPLiteVersion.lua"
            }
        }
    },
    [98752102030179] = {
...
local function ExecuteScript(selectedOption)
    ...
    for i = 1, 3 do
        local success, res = pcall(function() 
            return game:HttpGet(BASE_URL .. selectedOption.ScriptURL .. "?cache=" .. math.random(1, 999999)) 
        end)
